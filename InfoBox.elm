...
init inventory' storyLevel' storyChapter' storyPhases' storyPhaseChapters' infoPages' =
  let
    totalStoryLevels' =
      List.length storyPhases'
  in
  { model
      | inventory = inventory'
      ...
      , styleMeter =
          Animation.style
            [ Animation.width (Animation.px (toFloat (model.meterWidth // totalStoryLevels'))) 
            ]
  }
